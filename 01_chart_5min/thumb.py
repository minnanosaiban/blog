...
ax_l.text(0.110, 0.902, '連載 1-1', color=BLUE_L, fontsize=24, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.69, '株価取得', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.add_patch(patches.Rectangle((0.07, 0.578), 0.85, 0.004, facecolor=BLUE_L, linewidth=0, alpha=0.6))
ax_l.text(0.07, 0.48, 'CSVより処理の早い', color=BLUE_L, fontsize=36, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.37, 'parquet形式を利用', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')
...
OUT = r"C:/minnanosaiban/hotline/docs/blog/posts/img/01_get_stock_prices/00_thumbnail.png"
