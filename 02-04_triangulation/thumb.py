...
ax_l.text(0.07, 0.69, '予想', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.text(0.46, 0.69, '× 業績', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')
