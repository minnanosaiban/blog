...
ax_l.text(0.07, 0.69, 'ランダム', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.text(0.80, 0.69, 'フォレスト', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')
ax_l.add_patch(patches.Rectangle((0.07, 0.578), 0.85, 0.004, facecolor=BLUE_L, linewidth=0, alpha=0.6))
ax_l.text(0.07, 0.48, '予測は失敗！決算から ', color=BLUE_L, fontsize=36, va='center', ha='left', fontweight='bold')
