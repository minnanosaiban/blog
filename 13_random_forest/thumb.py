...
ax_l.text(0.07, 0.70, 'ランダム', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.55, 'フォレスト', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.add_patch(patches.Rectangle((0.07, 0.45), 0.85, 0.004, facecolor=BLUE_L, linewidth=0, alpha=0.6))
ax_l.text(0.07, 0.35, '予測は失敗！決算から', color=BLUE_L, fontsize=36, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.24, 'CAR は当てられない', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')

ax_r = fig.add_axes([0.55, 0.08, 0.41, 0.84], facecolor=BG)
ax_r.set_xlim(0, 100)
ax_r.set_ylim(0, 100)
ax_r.axis('off')
