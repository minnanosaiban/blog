...
連載記事: [K-NN 分類 ― 似た決算群から外れた「個別ショック」を検出](https://minnanosaiban.github.io/hotline/blog/posts/03-02_knn_prediction/)
...
| `make_images.py` | チャート生成 | 記事用 PNG（パイプライン図・個別ショック Top-10） |
