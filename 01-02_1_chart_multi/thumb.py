...
ax_l.text(0.07, 0.70, 'EDINET', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.55, 'TDnet', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.add_patch(patches.Rectangle((0.07, 0.45), 0.85, 0.004, facecolor=BLUE_L, linewidth=0, alpha=0.6))
ax_l.text(0.07, 0.35, '株価以外のデータを', color=BLUE_L, fontsize=36, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.24, '3 ソースから集める', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')
