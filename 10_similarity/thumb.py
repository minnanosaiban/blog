"""
連載15 類似決算検索 サムネイル生成
出力: docs/blog/posts/img/10_similar_earnings_search/00_thumbnail.png
"""
import os
...
ax_l.text(0.07, 0.70, 'コサイン', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.55, '類似度', color=WHITE, fontsize=72, va='center', ha='left', fontweight='bold')
ax_l.set_xlim(0, 1)
ax_l.set_ylim(0, 1)
ax_l.add_patch(patches.Rectangle((0.07, 0.45), 0.85, 0.004, facecolor=BLUE_L, linewidth=0, alpha=0.6))
ax_l.text(0.07, 0.35, '数値特徴量で', color=BLUE_L, fontsize=36, va='center', ha='left', fontweight='bold')
ax_l.text(0.07, 0.24, '「類似決算」を発見', color=WHITE, fontsize=36, va='center', ha='left', fontweight='bold')
...
ax_r.add_patch(patches.FancyBboxPatch((-3.3, -3.35), 6.6, 1.55,
